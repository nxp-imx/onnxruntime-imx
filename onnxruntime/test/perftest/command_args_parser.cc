...
/*static*/ void CommandLineParser::ShowUsage() {
  printf(
      ...
      "\t-e [cpu|cuda|dnnl|tensorrt|openvino|dml|acl|nnapi|coreml|qnn|snpe|rocm|migraphx|xnnpack|vitisai|webgpu|vsinpu|neutron]: Specifies the provider 'cpu','cuda','dnnl','tensorrt', "
      "'nvtensorrtrtx', 'openvino', 'dml', 'acl', 'nnapi', 'coreml', 'qnn', 'snpe', 'rocm', 'migraphx', 'xnnpack', 'vitisai', 'webgpu', 'vsinpu' or 'neutron'. "
      "Default:'cpu'.\n"
