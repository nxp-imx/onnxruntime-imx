      ...
      case IN_B:
        {
          ...
          if (offline_packed_ || magic == MAGIC_WORD) {
            ...
            auto total_len = ALIGN16_SIZE(header_len) + ALIGN16_SIZE(weight_len) + ALIGN16_SIZE(bias_len) * 2
            ...
            m_b_row_sum    = (int32_t*)((int8_t*)m_decode_input + ALIGN16_SIZE(idecode_len));
            ...
            memcpy(m_b_row_sum,    unpacked_b + offset, bias_len);
            ...
            memcpy(m_b_row_sum, row_sum, bias_len);
